...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (aiModal) {
        ...
        window.openAiModal = function (studentName, studentId, courseLabel, courseId) {
                ...
                queueBody.querySelectorAll('.attention-action').forEach(btn => {
                    btn.addEventListener('click', () => {
                        if (btn.classList.contains('btn-ai')) {
                            if (window.openAiModal) window.openAiModal(btn.dataset.name, btn.dataset.id, btn.dataset.course, btn.dataset.courseId || null);
                        } else {
